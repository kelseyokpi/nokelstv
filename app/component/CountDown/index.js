...
// const DEFAULT_TIME_TO_SHOW = ['D', 'H', 'M'];
const DEFAULT_TIME_TO_SHOW = ['D'];
// const DEFAULT_TIME_TO_SHOW = ['H', 'M', 'S'];
...
class CountDown extends React.Component {
  ...
  renderCountDown = () => {
    const { timeToShow, timeLabels, showSeparator, paymentStatus } = this.props;
