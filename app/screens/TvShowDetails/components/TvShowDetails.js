...
import { COMMONTHEMECOLOR, FONT_FAMILY_REGULAR, LIGHT_GREY_COLOR_CODE, WHITE_COLOR_CODE }
    from '../../../utils/constant';
...
const TvShowDetails = (props) => {
    ...
    const dynamic = { uri: props.baseURL.trailer_url + props.apiData.trailer };
    ...
    function _renderItems(item, index) {
        ...
        return (
            <TouchableOpacity onPress={() => _handleIsSelected(index, item)}
                style={lablestyle}>
                    ...
                    {props.MoviePlay ?
                        <View>
                            <Video
                                ...
                                resizeMode={'contain'}
                                style={{
                                    height: props.ShowFullscreen ? height : height / 2,
                        ...
                        <View style={{}}>
                            <Fragment>
                                ...
                                <Image
                                    ...
                                    onLoadEnd={() => props.onLoadEnd()}
                                    source={
                                        props.baseURL.banner_url + props.apiData.serial_banner ?
                                ...
                                {/* <Image
                                    ...
                                    resizeMode={"contain"}
                                    style={styles.mainimg ? styles.mainimg : styles.loadingImg}
                                /> */}
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                <>
                                    ...
                                    <View style={{
                                        paddingLeft: 15, backgroundColor: LIGHT_GREY_COLOR_CODE, marginLeft: 15, marginRight: 15,
